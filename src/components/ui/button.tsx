  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg font-semibold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        capture: "bg-primary text-primary-foreground shadow-lg hover:bg-primary/90 [&_svg]:size-8",
      },
      size: {
        default: "h-12 px-6 py-3 text-body",
        sm: "h-10 rounded-md px-4 text-label",
        lg: "h-14 rounded-xl px-8 text-body-lg",
        xl: "h-20 w-20 rounded-full text-heading",
        icon: "h-12 w-12",
      },
    },
    defaultVariants: {
